...
},v=_("//","$"),N=_("/\\*","\\*/"),w=_("#","$");var y=Object.freeze({
...
C_BLOCK_COMMENT_MODE:N,HASH_COMMENT_MODE:w,NUMBER_MODE:{className:"number",
...
;const R="of and for in not or if then".split(" ");function k(e){
...
return r(e,{variants:null},n)}))),e.cached_variants?e.cached_variants:O(e)?r(e,{
...
}),e.illegal&&n.addRule(e.illegal,{type:"illegal"}),n}(l),l}(e)}function O(e){
return!!e&&(e.endsWithParent||O(e.starts))}function M(e,n){
...
const A=t,I=r,{nodeStream:T,mergeStreams:j}=i,S=Symbol("nomatch")
...
;w("before:highlight",s);const i=s.result?s.result:p(s.language,s.code,t,r)
;return i.code=s.code,w("after:highlight",i),i}function p(e,t,r,i){const a=t
...
if(!s[y.subLanguage])return void O.addText(M)
;e=p(y.subLanguage,M,!0,R[y.subLanguage]),R[y.subLanguage]=e.top
}else e=m(M,y.subLanguage.length?y.subLanguage:null)
;y.relevance>0&&(L+=e.relevance),O.addSublanguage(e.emitter,e.language)
}():function(){if(!y.keywords)return void O.addText(M);let e=0
...
;O.addText(t),t="",L+=s;const i=v.classNameAliases[e]||e;O.addKeyword(n[0],i)
}else t+=n[0];e=y.keywordPatternRe.lastIndex,n=y.keywordPatternRe.exec(M)}
t+=M.substr(e),O.addText(t)}(),M=""}function g(e){
return e.className&&O.openNode(v.classNameAliases[e.className]||e.className),
...
return 0===y.matcher.regexIndex?(M+=e[0],1):(j=!0,0)}function b(e){
...
y.className&&O.closeNode(),y.skip||y.subLanguage||(L+=y.relevance),y=y.parent
}while(y!==r.parent)
...
Error('Unknown language: "'+e+'"');const N=k(v);let w="",y=i||N
;const R={},O=new d.__emitter(d);!function(){const e=[]
;for(let n=y;n!==v;n=n.parent)n.className&&e.unshift(n.className)
;e.forEach((e=>O.openNode(e)))}();let M="",L=0,I=0,T=0,j=!1;try{
for(y.matcher.considerAll();;){
T++,j?j=!1:y.matcher.considerAll(),y.matcher.lastIndex=I
;const e=y.matcher.exec(a);if(!e)break;const n=E(a.substring(I,e.index),e)
;I=e.index+n}return E(a.substr(I)),O.closeAllNodes(),O.finalize(),w=O.toHTML(),{
relevance:L,value:w,language:e,illegal:!1,emitter:O,top:y}}catch(n){
if(n.message&&n.message.includes("Illegal"))return{illegal:!0,illegalBy:{
msg:n.message,context:a.slice(I-100,I+100),mode:n.mode},sofar:w,relevance:0,
value:A(a),emitter:O};if(o)return{illegal:!1,relevance:0,value:A(a),emitter:O,
...
;return n.emitter.addText(e),n}(e),r=n.filter(_).filter(N).map((n=>p(n,e,!1)))
;r.unshift(t);const i=r.sort(((e,n)=>n.relevance-e.relevance)),[a,o]=i,l=a
...
;if(h(t))return;w("before:highlightBlock",{block:e,language:t
}),d.useBR?(n=document.createElement("div"),
n.innerHTML=e.innerHTML.replace(/\n/g,"").replace(/<br[ /]*>/g,"\n")):n=e
;const r=n.textContent,s=t?f(t,r,!0):m(r),a=T(n);if(a.length){
const e=document.createElement("div");e.innerHTML=s.value,s.value=j(a,T(e),r)}
s.value=b(s.value),w("after:highlightBlock",{block:e,result:s
...
}))}function N(e){const n=_(e);return n&&!n.disableAutodetect}function w(e,n){
...
d=I(d,e)},initHighlighting:E,initHighlightingOnLoad:function(){
...
requireLanguage:function(e){const n=_(e);if(n)return n
;throw Error("The '{}' language is required, but not loaded.".replace("{}",e))},
autoDetection:N,inherit:I,addPlugin:function(e){a.push(e)},
vuePlugin:L(t).VuePlugin}),t.debugMode=function(){o=!1},t.safeMode=function(){
o=!0},t.versionString="10.3.99";for(const n in y)"object"==typeof y[n]&&e(y[n])

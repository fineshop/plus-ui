...
if __name__ == '__main__':
    ...
    locations_json_content = json.dumps(location_data, indent=2, ensure_ascii=False, sort_keys=True)
    dc_colos_json_content = json.dumps(match_data, indent=2, ensure_ascii=False, sort_keys=True)
